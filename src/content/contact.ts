export const contactSection = {
  ...
  form: {
    ...
    successBody:
      "Thanks for reaching out. Your note is queued and ready to send through your preferred channel.",
    fields: {
      name: {
        label: "Name",
      ...
      message: {
        label: "Message",
        placeholder: "Tell me about your portfolio, mandate, or project.",
